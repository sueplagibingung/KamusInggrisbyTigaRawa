...
import com.example.kamusinggris.Adapters.MeaningAdapter;
import com.example.kamusinggris.Adapters.PhoneticsAdapter;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        RequestManager manager = new RequestManager(MainActivity3.this);
    ...
    private final OnFetchDataListener listener = new OnFetchDataListener() {
        ...
        public void onFetchData(APIResponse apiResponse, String message) {
            ...
            if (apiResponse==null){
                Toast.makeText(MainActivity3.this, "Data Not Found!!!", Toast.LENGTH_SHORT).show();
                return;
            }
